...
window.onload = () => {
    ...
    const popularityDisplay = document.getElementById("language-popularity-display");
    ...
    const addToList = {
      ...
      listPopularity.onclick = () => {
        ...
        for(name in languageRanking){
            ...
            addToList2.appendToList(newList, languageRanking[name].rank, languageRanking[name].language);
        }
      }
}